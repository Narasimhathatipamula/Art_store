...
export default function Seller({setUser}) {
       ...
       <Row >
                            <Col  >
                               <div style={{height: "100%"}}>
                                            <img src={image} style={{marginLeft: "20%", marginTop: "14%", height: "53%", width: "60%"}} />
                            ...
                            <Col  >
                            <div style={{marginTop: "18%", marginLeft: "10%",backgroundColor: "white", border: "1px solid block", borderRadius: "10px",height: "70%", width: "70%", padding: "0.5%" }}>
                                
                                 <h5 style={{color: "black", marginLeft: "5%", marginTop: "10%"}}>Login and start shopping from your fevorite brands. Refer a friend and save 50% OFF </h5>
                                 <Form >
                                     ...
                                     <div style={{color: "white", marginTop: "5%"}}>
                                      <a style={{color: "#23216ad9", marginLeft: "32%"}} onClick={()=> navigate("/")}>Create Account</a>
                                     </div>
                                 </Form>
                              </div> 
                            </Col>
